...
typedef void (*x264_predict_t)( pixel_t *src );
typedef void (*x264_predict8x8_t)( pixel_t *src, pixel_t edge[33] );
typedef void (*x264_predict_8x8_filter_t) ( pixel_t *src, pixel_t edge[33], int i_neighbor, int i_filters );
