...
static int name( pixel_t *pix1, int i_stride_pix1,  \
...
int64_t x264_pixel_ssd_wxh( x264_pixel_function_t *pf, pixel_t *pix1, int i_pix1, pixel_t *pix2, int i_pix2, int i_width, int i_height )
{
    int64_t i_ssd = 0;
    int y;
...
static uint64_t name( pixel_t *pix, int i_stride ) \
{                                             \
 ...
 * pixel_var2_wxh
 ****************************************************************************/
static int pixel_var2_8x8( pixel_t *pix1, int i_stride1, pixel_t *pix2, int i_stride2, int *ssd )
{
...
static NOINLINE int x264_pixel_satd_4x4( pixel_t *pix1, int i_pix1, pixel_t *pix2, int i_pix2 )
{
    uint32_t tmp[4][2];
...
static NOINLINE int x264_pixel_satd_8x4( pixel_t *pix1, int i_pix1, pixel_t *pix2, int i_pix2 )
{
    uint32_t tmp[4][4];
...
static int x264_pixel_satd_##w##x##h( pixel_t *pix1, int i_pix1, pixel_t *pix2, int i_pix2 )\
{\
...
static NOINLINE int sa8d_8x8( pixel_t *pix1, int i_pix1, pixel_t *pix2, int i_pix2 )
{
    uint32_t tmp[8][4];
...
static int x264_pixel_sa8d_8x8( pixel_t *pix1, int i_pix1, pixel_t *pix2, int i_pix2 )
{
    int sum = sa8d_8x8( pix1, i_pix1, pix2, i_pix2 );
    return (sum+2)>>2;
}

static int x264_pixel_sa8d_16x16( pixel_t *pix1, int i_pix1, pixel_t *pix2, int i_pix2 )
{
    int sum = sa8d_8x8( pix1, i_pix1, pix2, i_pix2 )
...
static NOINLINE uint64_t pixel_hadamard_ac( pixel_t *pix, int stride )
{
    uint32_t tmp[32];
...
static uint64_t x264_pixel_hadamard_ac_##w##x##h( pixel_t *pix, int stride )\
{\
 ...
 ****************************************************************************/
#define SAD_X( size ) \
static void x264_pixel_sad_x3_##size( pixel_t *fenc, pixel_t *pix0, pixel_t *pix1, pixel_t *pix2, int i_stride, int scores[3] )\
{\
...
static void x264_pixel_sad_x4_##size( pixel_t *fenc, pixel_t *pix0, pixel_t *pix1, pixel_t *pix2, pixel_t *pix3, int i_stride, int scores[4] )\
{\
    scores[0] = x264_pixel_sad_##size( fenc, FENC_STRIDE, pix0, i_stride );\
    scores[1] = x264_pixel_sad_##size( fenc, FENC_STRIDE, pix1, i_stride );\
    scores[2] = x264_pixel_sad_##size( fenc, FENC_STRIDE, pix2, i_stride );\
...
static void x264_pixel_satd_x3_##size##cpu( pixel_t *fenc, pixel_t *pix0, pixel_t *pix1, pixel_t *pix2, int i_stride, int scores[3] )\
{\
...
static void x264_pixel_satd_x4_##size##cpu( pixel_t *fenc, pixel_t *pix0, pixel_t *pix1, pixel_t *pix2, pixel_t *pix3, int i_stride, int scores[4] )\
{\
    scores[0] = x264_pixel_satd_##size##cpu( fenc, FENC_STRIDE, pix0, i_stride );\
    scores[1] = x264_pixel_satd_##size##cpu( fenc, FENC_STRIDE, pix1, i_stride );\
    scores[2] = x264_pixel_satd_##size##cpu( fenc, FENC_STRIDE, pix2, i_stride );\
 ...
 ****************************************************************************/
static void ssim_4x4x2_core( const pixel_t *pix1, int stride1,
                             const pixel_t *pix2, int stride2,
                             int sums[2][4])
{
    for( int z = 0; z < 2; z++ )
    {
...
float x264_pixel_ssim_wxh( x264_pixel_function_t *pf,
                           pixel_t *pix1, int stride1,
                           pixel_t *pix2, int stride2,
