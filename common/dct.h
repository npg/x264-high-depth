...
typedef struct
{
    ...
    void (*sub4x4_dct)   ( int16_t dct[16], pixel_t *pix1, pixel_t *pix2 );
    void (*add4x4_idct)  ( pixel_t *p_dst, int16_t dct[16] );

    void (*sub8x8_dct)   ( int16_t dct[4][16], pixel_t *pix1, pixel_t *pix2 );
    void (*sub8x8_dct_dc)( int16_t dct[4], pixel_t *pix1, pixel_t *pix2 );
    void (*add8x8_idct)  ( pixel_t *p_dst, int16_t dct[4][16] );
    void (*add8x8_idct_dc) ( pixel_t *p_dst, int16_t dct[4] );

    void (*sub16x16_dct) ( int16_t dct[16][16], pixel_t *pix1, pixel_t *pix2 );
    void (*add16x16_idct)( pixel_t *p_dst, int16_t dct[16][16] );
    void (*add16x16_idct_dc) ( pixel_t *p_dst, int16_t dct[16] );

    void (*sub8x8_dct8)  ( int16_t dct[64], pixel_t *pix1, pixel_t *pix2 );
    void (*add8x8_idct8) ( pixel_t *p_dst, int16_t dct[64] );

    void (*sub16x16_dct8) ( int16_t dct[4][64], pixel_t *pix1, pixel_t *pix2 );
    void (*add16x16_idct8)( pixel_t *p_dst, int16_t dct[4][64] );
...
typedef struct
{
    ...
    int  (*sub_8x8)  ( int16_t level[64], const pixel_t *p_src, pixel_t *p_dst );
    int  (*sub_4x4)  ( int16_t level[16], const pixel_t *p_src, pixel_t *p_dst );
    int  (*sub_4x4ac)( int16_t level[16], const pixel_t *p_src, pixel_t *p_dst, int16_t *dc );
